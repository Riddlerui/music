      ...
      <div class="normal-player" v-show="fullScreen">
        ...
        <div class="bottom">
          <div class="dot-wrapper">
            <span class="dot" :class="{'active': currrentShow === 'cd'}"></span>
            <span class="dot" :class="{'active': currrentShow === 'lyric'}"></span>
          </div>
...
export default {
  ...
  methods: {
    ...
    middleTouchMove(e) {
      ...
      const left = this.currrentShow === 'cd' ? 0 : -window.innerWidth
    ...
    middleTouchEnd() {
      let offsetWidth
      let opacity
      if(this.currrentShow === 'cd') {
        if(this.touch.percent > 0.1) {
          offsetWidth = -window.innerWidth
          opacity = 0
          this.currrentShow = 'lyric'
        } else {
          offsetWidth = 0
          opacity = 1
        }
